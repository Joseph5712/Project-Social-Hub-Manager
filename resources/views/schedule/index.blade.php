...
<body class="bg-gray-100">
    <div class="container mx-auto p-6">
        ...
        <a href="{{ route('schedule.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Crear Nuevo Horario</a>
                ...
                @foreach($schedules as $schedule)
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-2 flex space-x-2">
                            <a href="{{ route('schedule.edit', $schedule) }}" class="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600">Editar</a>
                            <form action="{{ route('schedule.destroy', $schedule) }}" method="POST" onsubmit="return confirm('¿Estás seguro?')">
                                @csrf
                                @method('DELETE')
